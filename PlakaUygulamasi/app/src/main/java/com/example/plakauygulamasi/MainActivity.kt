package com.example.plakauygulamasi

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.plakauygulamasi.databinding.ActivityMainBinding
        ...
        binding.button.setOnClickListener {
            ...
            var plakaKodu=binding.editTextNumber.text.toString().toInt()
                when(plakaKodu){
                    ...
                    else->binding.textView.text="Lütfen Geçerli Bir İl Gir!"
                }
            }

            else{binding.textView.text="Lütfen Bir il gir!!"}
